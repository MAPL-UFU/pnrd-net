from sawtooth_sdk.messaging import Connection
...
from dispatcher.transaction_creation import make_create_owner_transaction
from dispatcher.transaction_creation import make_create_record_transaction
from dispatcher.transaction_creation import make_transfer_record_transaction
from dispatcher.transaction_creation import make_update_record_transaction
...
class Dispatcher(object):
    def __init__(self, sawtooth_rest_api_url=DEFAULT_URL_SAWTOOH_REST_API):
        self._connection = Connection(sawtooth_rest_api_url)
    ...
    def send_create_agent_transaction(self,
                                      private_key,
                                      name,
                                      timestamp):
